...
Discord はリアルタイムの雑談・コンテスト中の盛り上がり・コミュニティ全体へのアナウンスに向いており、AtCoder NoviSteps でも引き続き活用する。ただし Discord はコメント機能の代替にはならない。
...
両者は競合ではなく補完関係にある。問題に紐付いた非同期の議論はコメント機能、問題に紐付かないリアルタイム交流は Discord が担う。
