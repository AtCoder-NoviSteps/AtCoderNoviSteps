...
- [ ] **Step 1: oxlint をインストール**

```bash
pnpm add -D oxlint
```

- [ ] **Step 2: `oxlint.json` を作成**
...
- [ ] **Step 1: JS/TS ファイルを ignores に追加、`js.configs.recommended` を削除**
...
- [ ] **Step 2: ESLint が .svelte のみを処理することを確認**
...
- [ ] **Step 3: `@eslint/js` を package.json から削除**
...
- [ ] **Step 1: Lefthook に oxlint ジョブを追加し、eslint ジョブを縮小**
...
- [ ] **Step 2: staged file に .ts を含む状態で動作確認**
...
- [ ] **Step 3: staged file に .svelte を含む状態で動作確認**
