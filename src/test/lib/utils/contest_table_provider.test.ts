...
vi.mock('$lib/utils/contest', () => ({
  classifyContest: vi.fn((contestId: string) => {
    ...
    } else if (contestId.startsWith('awc')) {
  ...
  getContestNameLabel: vi.fn((contestId: string) => {
    if (contestId.startsWith('abc')) {
      ...
      return `AWC ${contestId.replace('awc', '')}`;
      ...
      return 'Tenka1 2018 Beginner';
    } else if (contestId === 'tenka1-2019-beginner') {
      return 'Tenka1 2019 Beginner';
    } else if (contestId === 'caddi2018b') {
      return 'CADDi 2018 for Beginners';
    } else if (contestId === 'soundhound2018-summer-qual') {
      return 'SoundHound 2018';
    } else if (contestId === 'aising2019') {
      return 'Aising 2019';
    } else if (contestId === 'aising2020') {
      return 'Aising 2020';
    } else if (contestId === 'sumitrust2019') {
      return 'Sumitomo Mitsui Trust Bank Programming Contest 2019';
    } else if (contestId === 'hhkb2020') {
      return 'HHKB Programming Contest 2020';
    } else if (contestId === 'm-solutions2020') {
      return 'M-SOLUTIONS Programming Contest 2020';
    } else if (contestId === 'panasonic2020') {
      return 'Panasonic Programming Contest 2020';
    } else if (contestId === 'jsc2021') {
      return 'Japanese Student Championship 2021';
    } else if (contestId === 'zone2021') {
      return 'ZONe Energy Programming Contest 2021';
    } else if (contestId === 'jsc2025advance-final') {
      return '日本最強プログラマー学生選手権～Advance～';
    }
...
describe('ContestTableProviderBase and implementations', () => {
  ...
  describe('ABC-Like Provider', () => {
    ...
    test('expects to handle shared problem patterns (tenka1-201x-beginner → tenka1-201x)', () => {
      ...
      const tenka2017Beginner = filtered.filter(
        (task) => task.contest_id === 'tenka1-2017-beginner',
      );
  ...
  describe('AWC 0001 Onwards Provider', () => {
