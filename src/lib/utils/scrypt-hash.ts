// To generate user hashed passwords used in Lucia.

// TODO: Check the Lucia documentation to see if there is a published helper method for hash generation.

// See:
// https://github.com/lucia-auth/lucia/blob/main/packages/lucia/src/utils/crypto.ts
...
// See:
// https://github.com/lucia-auth/lucia/blob/main/packages/lucia/src/utils/nanoid.ts
const DEFAULT_ALPHABET = 'abcdefghijklmnopqrstuvwxyz1234567890';

const generateRandomString = (size: number, alphabet = DEFAULT_ALPHABET): string => {
...
// See:
// https://github.com/lucia-auth/lucia/blob/main/packages/lucia/src/scrypt/index.ts
/**
...
// https://github.com/lucia-auth/lucia/blob/main/packages/lucia/src/scrypt/pbkdf.ts
const pbkdf2 = async (
  password: Uint8Array,
  salt: Uint8Array,
  options: {
