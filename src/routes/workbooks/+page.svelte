<script lang="ts">
  ...
  import { getTaskGradeOrder, taskGradeOrderInfinity } from '$lib/utils/task';
  ...
  function calcGradeMode(taskGrades: TaskGrades): TaskGrade {
  ...
  function getGradeOrder(grade: TaskGrade): number {
